...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProductsByCategory(
        ...
        ProductResponse productResponse = productService.serchByCategoryId(categoryId, pageNumber, pageSize, sortBy, sortOrder);
        return new ResponseEntity<>(productResponse, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ProductDTO> getProductsByKeyword(@Valid @RequestBody ProductDTO productDTO,
